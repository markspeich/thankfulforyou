...
- Raw ShipStation error responses, including response bodies and provider-supplied messages, must remain private and must not appear in browser feedback, application logs, client telemetry, or persisted diagnostic metadata.
